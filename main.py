...
app_1_pontos = Label(frame_cima, text=":", height=1, anchor='center', font=('Ivy 30 bold'), bg=co1, fg=co0)
app_1_pontos.place(x=125, y=20)
...
icon_1 = Image.open('images/pedra.jpg')
icon_1 = icon_1.resize((50,50), Image.ANTIALIAS)
icon_1 = ImageTk.PhotoImage(icon_1)
b_icon_1 = Button(frame_baixo, width=50, imagem=icon_1, compound=CENTER, bg=co0, fg='co0', font=('Ivy 10 bold'), anchor=CENTER, relief=FLAT)
b_icon_1.place(x=15, y=60)

icon_2 = Image.open('images/papel.png.png')
icon_2 = icon_1.resize((50,50), Image.ANTIALIAS)
icon_2 = ImageTk.PhotoImage(icon_2)
b_icon_2 = Button(frame_baixo, width=50, imagem=icon_2, compound=CENTER, bg=co0, fg='co0', font=('Ivy 10 bold'), anchor=CENTER, relief=FLAT)
b_icon_2.place(x=95, y=60)

icon_3 = Image.open('images/tesoura.jpg.jpg')
icon_3 = icon_1.resize((50,50), Image.ANTIALIAS)
icon_3 = ImageTk.PhotoImage(icon_3)
b_icon_3 = Button(frame_baixo, width=50, imagem=icon_3, compound=CENTER, bg=co0, fg='co0', font=('Ivy 10 bold'), anchor=CENTER, relief=FLAT)
b_icon_3.place(x=170, y=60)

b_jogar = Button(frame_baixo, width=30, text='Jogar', bg=fundo, fg=co0 font=('Ivy 10 bold'), compound=CENTER, imagem=icon_3, compound=CENTER, bg=co0, fg='co0', font=('Ivy 10 bold'), anchor=CENTER, relief=RAISED, overrelief=RIDGE)
